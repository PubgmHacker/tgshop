...
export function HomeHero({
  ...
  return (
    <section className="glass glass-live overflow-hidden rounded-[28px] px-5 py-6">
      ...
      <h1 className="relative mt-4 text-[30px] font-bold leading-[1.12] tracking-[-0.03em] text-ink">
        {t('home.hero.title')}
      </h1>
      <p className="relative mt-2 text-[15px] leading-relaxed text-muted">{t('home.hero.sub')}</p>
